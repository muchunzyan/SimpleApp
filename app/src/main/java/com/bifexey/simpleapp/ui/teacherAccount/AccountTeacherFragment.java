package com.bifexey.simpleapp.ui.teacherAccount;
...
public class AccountTeacherFragment extends Fragment implements View.OnClickListener {
    ...
    TextView text_name, text_phone_number;
    TextView my_subjects_btn, FAQ_btn;
    ImageView img_account;
    LinearLayout btn_activity_student, btn_activity_teacher;
    TextView btn_add_teacher_subject, about_app_btn, settings_btn;
        ...
        myRefCurrentUser.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getChildrenCount() != 0) {
                    ...
                    text_phone_number.setText(user.getPhoneNumber());
                }
            }
